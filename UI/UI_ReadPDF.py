...
class Ui_widgetReadPDF(object):
    def setupUi(self, widgetReadPDF):
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(widgetReadPDF)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 476, 360))
        ...
        self.verticalLayout_2.addWidget(self.label_FileStatus)
